...
.layui-colla-title{position: relative; height: 60px; line-height: 60px; padding: 0 35px; color: #333; background-color: #ffffff; cursor: pointer; font-size: 16px;}
.layui-colla-content{display: none; padding: 10px 15px; line-height: 30px; color: #666;}
.layui-colla-icon{position: absolute; right: 15px; top: 0; font-size: 16px;color: #01965e;}
